...
function NosServices(props) {
    return (
        <div id="section2" className=" mt-6 md:mt-0 flex flex-col items-center md:pt-[10%] ">
            <h1 className="text-2xl pt-8 md:text-3xl font-bold text-accent">NOS SERVICES</h1>
