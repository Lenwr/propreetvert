...
import {aicha, quote} from "../../../public";
import './owner.css'
import '../globals.css'
        ...
        <div className="md:h-screen mt-8 md:mt-0 md:pt-[8%]  flex item-center">
            <div
                ...
                <div className="md:w-[60%] flex justify-center ">
                  ...
                  <span className=" flex w-[30px] flex-row">
                      <img className="mr-2" src="/quotes.png" alt="quote"/>
                        ...
                        <div className="flex justify-end">
                            <span className=" flex w-[30px] flex-row">
                            <img
                            className="mr-2" src="/quotes.png" alt="quote"/>      <img src="/quotes.png" alt="quote"/>    </span>
                        </div>
                    </div>
                </div>
                <div className="aicha md:w-[35%] p-4 flex flex-col justify-center items-center  ">
                    <img src="/aicha.JPG" className="md:w-[10em] lg:w-[8em] xl:w-[12em]  rounded-2xl object-contain shadow-2xl " alt=""/>
                    <div
